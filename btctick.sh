...
then
	...
	echo "----------"
	echo
	echo "You are at btctick master branch edit 2026-05-04 - default FIAT is USD (\$)."
	echo "btctick is public domain with NO WARRANTY. Use at your own discretion."
	echo
	echo "NEWS: Happy May Day 2026! Prepare for the next bull run in ca. 3 years, it will be sooner than you think!"
	echo
	date
