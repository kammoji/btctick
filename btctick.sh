...
then
	...
	echo "----------"
	echo
	echo "You are at btctick master branch edit 2026-08-03 - default FIAT is USD (\$)."
	echo "btctick is public domain with NO WARRANTY. Use at your own discretion."
	echo
	echo "NEWS: Celebrating BTC Bear Summer and August 2026! Prepare for the next bull run in ca. 3 years! A bear market is a great chance to start stacking Sats, visit https://konekettu.fi for opportunities."
	echo
	date
